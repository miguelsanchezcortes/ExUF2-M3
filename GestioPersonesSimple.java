...
public class GestioPersonesSimple {
        ...
        do {
            ...
            switch (opcio) {
                ...
                case 3:// 3.Llistar persona
                    llistarPersona(persones);

                    break;
                case 4:// 4.Modificar persona
                    modificarPersona(persones);

                    break;
                case 5:// 5.Eliminar persona
                    eliminarPersona(persones);
    ...
    public static void afegirPersona(String[][] persones) {
        String[][] personesAux;
    ...
    private static void llistarPersona(String[][] persones) {
        int posPersona = 0;
    ...
    private static void modificarPersona(String[][] persones) {
        boolean trobat = false;
        String nom = "", cognom = "", edat = "", telefon = "";
        int posPersona = 0;
        if (persones.length == 0) {
    ...
    private static void eliminarPersona(String[][] persones) {
        boolean trobat = false;
        String[][] personesAux;
        int posPersona = 0;
        if (persones.length == 0) {
